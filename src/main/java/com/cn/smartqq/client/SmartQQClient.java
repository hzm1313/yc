package com.cn.smartqq.client;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.cn.smartqq.callback.MessageCallback;
import com.cn.smartqq.constant.ApiURL;
...
public class SmartQQClient implements Closeable {
    ...
    private String imageFilePath = "qrcode.png";
    //客户端
    ...
    public SmartQQClient(final MessageCallback callback, String imageFilePath) {
    ...
    private void getQRCode() {
        ...
        String filePath;
        try {
            filePath = new File(imageFilePath).getCanonicalPath();
        } catch (IOException e) {
        ...
        try{
            ...
            LOGGER.error("请求失败，二维码请求 "+e.getMessage());
        }
    ...
    private String verifyQRCode() {
        ...
        while (true) {
            ...
            try{
                 response =  get(ApiURL.VERIFY_QR_CODE, hash33(qrsig));
            }catch (Exception e){
                LOGGER.error("请求失败，二维码请求 "+e.getMessage());
            }
            if(response!=null){
